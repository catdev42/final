...
/*   Updated: 2024/03/28 15:47:12 by myakoven         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//SECOND ATTEMPT - actually less efficient than the original...
...
// 			first_to_last(stack_a);
// 		}
// 		if (started_hold == 1 && (*stack_a)->x > holding)
// 		{
// 			holding = (*stack_a)->x;
// 			if (write(1, "sa\n", 3) == -1)
// 				return (0);
